            ...
            <React.Fragment>
                ...
                <div className="footer_bar d-flex justify-content-center text-center">
                    <div className="copyright">
                        ...
                        <p><a className="text-light" href="contacto.html" target="_blank">Contacto </a>|<a className="text-light font-weight-bold" href="aviso.html" target="_blank"> Aviso legal y Política de privacidad</a></p>
                    </div>
                </div>
