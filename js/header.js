            ...
            <nav className={this.state.logo==='big'?'navbar navbar-expand-lg navbar-dark fixed-top d-flex justify-content-between':'navColor navbar navbar-expand-lg navbar-dark fixed-top d-flex justify-content-between'}>
                ...
                <div id="mySidenav" ref={node => this.node = node} className={`sidenav text-right ${this.state.active}`}>
                    ...
                    <div className="form-inline justify-content-end">
                        ...
                        <a href="javascript:" uk-icon="linkedin" uk-tooltip="title: No disponible; delay: 500" className="border-white border rounded-circle p-2"></a>
                        <a href="javascript:" uk-icon="facebook" uk-tooltip="title: No disponible; delay: 500" className="border-white border  rounded-circle p-2"></a>
                        <a href="javascript:" uk-icon="twitter" uk-tooltip="title: No disponible; delay: 500" className="border-white border  rounded-circle p-2"></a>
                    </div>
                </div>
                <div id="main">
